...
#define STRING_CONFIG_H_AUTHOR "(NightStorm, FLSUN QQ)" // Who made the changes.
...
#define DELTA
  ...
  #define DELTA_HEIGHT 371.96 // get this value from auto calibrate

  #define DELTA_ENDSTOP_ADJ { 0.0, 0.0, 0.0 } // get these from auto calibrate

  // Horizontal distance bridged by diagonal push rods when effector is centered.
  #define DELTA_RADIUS 141.79 //mm  Get this value from auto calibrate

  // Trim adjustments for individual towers
  // tower angle corrections for X and Y tower / rotate XYZ so Z tower angle = 0
  // measured in degrees anticlockwise looking from above the printer
  #define DELTA_TOWER_ANGLE_TRIM { 0.45, -0.35,-0.10 } // get these values from auto calibrate
...
//#define DEBUG_LEVELING_FEATURE
  ...
  //#define   (DELTA_PRINTABLE_RADIUS - 10)
  /**
